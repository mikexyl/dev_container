...
var require_range = __commonJS((exports2, module2) => {
  var Range9 = class {
    constructor(range, options) {
      options = parseOptions(options);
      if (range instanceof Range9) {
        if (range.loose === !!options.loose && range.includePrerelease === !!options.includePrerelease) {
          return range;
        } else {
          return new Range9(range.raw, options);
        }
      }
  ...
  var Comparator = class {
    ...
    intersects(comp, options) {
      ...
      if (this.operator === "") {
        ...
        return new Range9(comp.value, options).test(this.value);
      } else if (comp.operator === "") {
        if (comp.value === "") {
          return true;
        }
        return new Range9(this.value, options).test(comp.semver);
      }
...
var require_satisfies = __commonJS((exports2, module2) => {
  ...
  var satisfies = (version, range, options) => {
    try {
      range = new Range9(range, options);
    } catch (er) {
      return false;
    }
...
var require_to_comparators = __commonJS((exports2, module2) => {
  var Range9 = require_range();
  var toComparators = (range, options) => new Range9(range, options).set.map((comp) => comp.map((c) => c.value).join(" ").trim().split(" "));
...
var require_max_satisfying = __commonJS((exports2, module2) => {
  ...
  var maxSatisfying = (versions, range, options) => {
    ...
    let rangeObj = null;
    try {
      rangeObj = new Range9(range, options);
    } catch (er) {
      return null;
    }
    versions.forEach((v) => {
...
var require_valid2 = __commonJS((exports2, module2) => {
  ...
  var validRange = (range, options) => {
    try {
      return new Range9(range, options).range || "*";
    } catch (er) {
      return null;
    }
  };
...
var require_intersects = __commonJS((exports2, module2) => {
  ...
  var intersects = (r1, r2, options) => {
    r1 = new Range9(r1, options);
    r2 = new Range9(r2, options);
...
var require_subset = __commonJS((exports2, module2) => {
  ...
  var subset = (sub, dom, options) => {
    if (sub === dom)
      return true;
    sub = new Range9(sub, options);
    dom = new Range9(dom, options);
  ...
  function patch(fs5) {
    ...
    function patchLchmod(fs6) {
      fs6.lchmod = function(path10, mode, callback) {
        fs6.open(path10, constants.O_WRONLY | constants.O_SYMLINK, mode, function(err, fd) {
          if (err) {
            if (callback)
              callback(err);
            return;
  ...
  module2.exports.makeDir = async (input, options) => {
    ...
    const make = async (pth) => {
      try {
        ...
        try {
          const stats = await fs5.stat(pth);
...
var require_utimes = __commonJS((exports2, module2) => {
  ...
  function utimesMillisSync(path10, atime, mtime) {
    const fd = fs5.openSync(path10, "r+");
...
var require_path_exists = __commonJS((exports2, module2) => {
  ...
  function pathExists(path10) {
    return fs5.access(path10).then(() => true).catch(() => false);
  }
  module2.exports = {
...
var require_named_js_regexp = __commonJS((exports2, module2) => {
  ...
  (function(window8) {
    ...
    if (typeof exports2 !== "undefined") {
      ...
      window8.createNamedRegex = createNamedRegex;
    }
...
var PythonSettings2 = class {
  ...
  static getInstance() {
    ...
    const workspaceFolderUri = workspaceFolder ? import_coc.Uri.parse(workspaceFolder.uri) : void 0;
  ...
  update(pythonSettings) {
    ...
    this.linting = this.linting ? this.linting : {
      ...
      pylintCategorySeverity: {
        convention: import_coc.DiagnosticSeverity.Hint,
        error: import_coc.DiagnosticSeverity.Error,
        fatal: import_coc.DiagnosticSeverity.Error,
        refactor: import_coc.DiagnosticSeverity.Hint,
        warning: import_coc.DiagnosticSeverity.Warning
      },
      pep8CategorySeverity: {
        E: import_coc.DiagnosticSeverity.Error,
        W: import_coc.DiagnosticSeverity.Warning
      },
      flake8CategorySeverity: {
        E: import_coc.DiagnosticSeverity.Error,
        W: import_coc.DiagnosticSeverity.Warning,
        F: import_coc.DiagnosticSeverity.Warning
      },
      mypyCategorySeverity: {
        error: import_coc.DiagnosticSeverity.Error,
        note: import_coc.DiagnosticSeverity.Hint
      },
  ...
  initialize() {
    this.disposables.push(import_coc.workspace.onDidChangeConfiguration((event) => {
...
function getPythonExecutable(pythonPath) {
  ...
  for (let executableName of KnownPythonExecutables) {
    if (process.platform === "win32") {
      ...
      if (isValidPythonPath(import_path.default.join(pythonPath, executableName))) {
        return import_path.default.join(pythonPath, executableName);
      }
      if (isValidPythonPath(import_path.default.join(pythonPath, "scripts", executableName))) {
        return import_path.default.join(pythonPath, "scripts", executableName);
      }
    } else {
      if (isValidPythonPath(import_path.default.join(pythonPath, executableName))) {
        return import_path.default.join(pythonPath, executableName);
      }
      if (isValidPythonPath(import_path.default.join(pythonPath, "bin", executableName))) {
        return import_path.default.join(pythonPath, "bin", executableName);
      }
    }
  }
  return pythonPath;
...
var Edit = class {
  ...
  apply() {
    switch (this.action) {
      case 1:
        return import_coc2.TextEdit.insert(this.start, this.text);
      case 0:
        return import_coc2.TextEdit.del(import_coc2.Range.create(this.start, this.end));
      case 2:
        return import_coc2.TextEdit.replace(import_coc2.Range.create(this.start, this.end), this.text);
      default:
        return {
          range: import_coc2.Range.create(0, 0, 0, 0),
          newText: ""
        };
    }
  }
...
function getWindowsLineEndingCount(document, offset) {
  ...
  for (let pos = 0; pos < offset; pos += readBlock) {
    ...
    const text = document.getText(import_coc2.Range.create(startAt, endAt));
...
var PythonExecutionService = class {
  ...
  async isModuleInstalled(moduleName) {
    return this.procService.exec(this.pythonPath, ["-c", `import ${moduleName}`], {throwOnStdErr: true}).then(() => true).catch(() => false);
  }
...
function getTempFileWithDocumentContents(document) {
  return new Promise((resolve, reject) => {
    const fsPath = import_coc3.Uri.parse(document.uri).fsPath;
    const ext = import_path2.default.extname(fsPath);
    const fileName = `${fsPath}.${import_md5.default(document.uri)}${ext}`;
    import_fs_extra.default.writeFile(fileName, document.getText(), (ex) => {
      if (ex) {
...
var BaseFormatter = class {
  ...
  getDocumentPath(document, fallbackPath) {
    const filepath = import_coc3.Uri.parse(document.uri).fsPath;
  ...
  getWorkspaceUri(document) {
    const filepath = import_coc3.Uri.parse(document.uri).fsPath;
    if (!filepath.startsWith(import_coc3.workspace.root))
      return;
    return import_coc3.Uri.file(import_coc3.workspace.root);
  }
  ...
  async provideDocumentFormattingEdits(document, _options, token, args, cwd) {
    if (typeof cwd !== "string" || cwd.length === 0) {
      cwd = import_coc3.Uri.file(import_coc3.workspace.root).fsPath;
    }
    const filepath = import_coc3.Uri.parse(document.uri).fsPath;
    ...
    promise.then(() => {
      ...
      import_coc3.window.showMessage(`Formatted with ${this.Id}`);
  ...
  async handleError(_expectedFileName, error) {
    ...
    import_coc3.window.showMessage(customError, "warning");
  }
  ...
  deleteTempFile(originalFile, tempFile) {
    if (originalFile !== tempFile) {
      return import_util.promisify(import_fs_extra.default.unlink)(tempFile);
    }
  ...
  formatDocument(document, options, token, range) {
    ...
    if (formatSelection) {
      const errorMessage = async () => {
        ...
        import_coc4.window.showMessage('Black does not support the "Format Selection" command', "error");
        return [];
      };
      return errorMessage();
    }
...
var DarkerFormatter = class extends BaseFormatter {
  ...
  createTempFile(document) {
    return new Promise((resolve) => {
      resolve(import_coc5.Uri.parse(document.uri).fsPath);
    });
  }
...
var PythonFormattingEditProvider = class {
  constructor() {
    ...
    this.outputChannel = import_coc6.window.createOutputChannel("coc-pyright-formatting");
...
var BaseLinter = class {
  ...
  async run(args, document, cancellation, regEx = REGEX) {
    if (!this.info.isEnabled(import_coc7.Uri.parse(document.uri))) {
      return [];
    }
    const executionInfo = this.info.getExecutionInfo(args, import_coc7.Uri.parse(document.uri));
    try {
      const pythonToolsExecutionService = new PythonExecutionService();
      const result = await pythonToolsExecutionService.exec(executionInfo, {cwd: import_coc7.workspace.root, token: cancellation, mergeStdOutErr: false});
...
`);
      ...
      await this.errorHandler.handleError(error, import_coc7.Uri.parse(document.uri), executionInfo).catch(() => {
      });
      return [];
    }
  }
...
var Bandit = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["-f", "custom", "--msg-template", "{line},0,{severity},{test_id}:{msg}", "-n", "-1", import_coc8.Uri.parse(document.uri).fsPath], document, cancellation);
...
var Flake8 = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["--format=%(row)d,%(col)d,%(code).1s,%(code)s:%(text)s", import_coc9.Uri.parse(document.uri).fsPath], document, cancellation);
    messages.forEach((msg) => {
...
var LinterInfo = class {
  ...
  getExecutionInfo(customArgs, resource) {
    ...
    let moduleName;
    if (path3.basename(execPath) === execPath) {
      moduleName = execPath;
    }
...
var MyPy = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run([import_coc10.Uri.parse(document.uri).fsPath], document, cancellation, REGEX2);
    messages.forEach((msg) => {
...
var Prospector = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const relativePath = import_path3.default.relative(import_coc12.workspace.root, import_coc12.Uri.parse(document.uri).fsPath);
...
var PyDocStyle = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run([import_coc13.Uri.parse(document.uri).fsPath], document, cancellation);
    messages.forEach((msg) => {
  ...
  async parseMessages(output, document, _token, _regEx) {
    ...
    const baseFileName = path5.basename(import_coc13.Uri.parse(document.uri).fsPath);
...
var PyLama = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const messages = await this.run(["--format=parsable", import_coc14.Uri.parse(document.uri).fsPath], document, cancellation, REGEX3);
    messages.forEach((msg) => {
      msg.severity = LintMessageSeverity.Warning;
    });
    return messages;
...
var Pylint = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    ...
    if (settings.linting.pylintUseMinimalCheckers && this.info.linterArgs(uri).length === 0 && !await this.hasConfigrationFileInWorkspace(path6.dirname(uri.fsPath), import_coc15.workspace.root) && !await this.hasConfigurationFile(import_coc15.workspace.root)) {
      minArgs = [
        "--disable=all",
  ...
  async hasConfigurationFile(folder) {
    ...
    if (await import_fs_extra2.default.pathExists(path6.join(folder, pylintrc)) || await import_fs_extra2.default.pathExists(path6.join(folder, dotPylintrc))) {
      return true;
    }
    let current = folder;
    let above = path6.dirname(folder);
    do {
      if (!await import_fs_extra2.default.pathExists(path6.join(current, "__init__.py"))) {
        break;
      }
      if (await import_fs_extra2.default.pathExists(path6.join(current, pylintrc)) || await import_fs_extra2.default.pathExists(path6.join(current, dotPylintrc))) {
        return true;
      }
      current = above;
      above = path6.dirname(above);
    } while (!this.arePathsSame(current, above));
    const home = os.homedir();
    if (await import_fs_extra2.default.pathExists(path6.join(home, dotPylintrc))) {
      return true;
    }
    if (await import_fs_extra2.default.pathExists(path6.join(home, ".config", pylintrc))) {
      return true;
    }
    if (!this.isWindows) {
      if (await import_fs_extra2.default.pathExists(path6.join("/etc", pylintrc))) {
        return true;
      }
    }
    return false;
  ...
  arePathsSame(path1, path22) {
    path1 = path6.normalize(path1);
    path22 = path6.normalize(path22);
    if (this.isWindows) {
  ...
  async hasConfigrationFileInWorkspace(folder, root) {
    let current = folder;
    let above = path6.dirname(current);
    do {
      if (await import_fs_extra2.default.pathExists(path6.join(current, pylintrc)) || await import_fs_extra2.default.pathExists(path6.join(current, dotPylintrc))) {
        return true;
      }
...
var Pytype = class extends BaseLinter {
  ...
  async runLinter(document, cancellation) {
    const args = [];
    if (await this.hasConfigurationFile(import_coc16.workspace.root)) {
      args.push(...["--config", pytypecfg]);
    }
    args.push(import_coc16.Uri.parse(document.uri).fsPath);
  ...
  async parseMessages(output, document, token, regEx) {
    ...
    const messages = (await super.parseMessages(newOutput, document, token, regEx)).filter((msg) => {
      return msg.file && msg.file === import_coc16.Uri.parse(document.uri).fsPath;
    });
  ...
  async hasConfigurationFile(folder) {
    if (await import_fs_extra3.default.pathExists(path7.join(folder, pytypecfg))) {
      return true;
    }
    let current = folder;
    ...
    do {
      ...
      if (await import_fs_extra3.default.pathExists(path7.join(current, pytypecfg))) {
        return true;
      }
      current = above;
...
lintSeverityToVSSeverity.set(LintMessageSeverity.Error, import_coc17.DiagnosticSeverity.Error);
lintSeverityToVSSeverity.set(LintMessageSeverity.Hint, import_coc17.DiagnosticSeverity.Hint);
lintSeverityToVSSeverity.set(LintMessageSeverity.Information, import_coc17.DiagnosticSeverity.Information);
lintSeverityToVSSeverity.set(LintMessageSeverity.Warning, import_coc17.DiagnosticSeverity.Warning);
...
var LintingEngine = class {
  constructor() {
    ...
    this.outputChannel = import_coc17.window.createOutputChannel("coc-pyright-linting");
    this.diagnosticCollection = import_coc17.languages.createDiagnosticCollection("python");
  ...
  async lintOpenPythonFiles() {
    ...
    const promises = import_coc17.workspace.textDocuments.map(async (document) => this.lintDocument(document));
  ...
  async lintDocument(document) {
    ...
    const cancelToken = new import_coc17.CancellationTokenSource();
    ...
    const activeLinters = await this.getActiveLinters(import_coc17.Uri.parse(document.uri));
  ...
  createDiagnostics(message, _document) {
    const position = import_coc17.Position.create(message.line - 1, message.column);
    const range = import_coc17.Range.create(position, position);
    const severity = lintSeverityToVSSeverity.get(message.severity);
    const diagnostic = import_coc17.Diagnostic.create(range, message.message, severity);
  ...
  shouldLintDocument(document) {
    ...
    const relativeFileName = import_path4.default.relative(import_coc17.workspace.root, import_coc17.Uri.parse(document.uri).fsPath);
    const ignoreMinmatches = settings.linting.ignorePatterns.map((pattern) => new import_minimatch.Minimatch(pattern, {dot: true}));
    if (ignoreMinmatches.some((matcher) => matcher.match(import_coc17.Uri.parse(document.uri).fsPath) || matcher.match(relativeFileName))) {
      this.outputChannel.appendLine(`${"#".repeat(5)} linting is ignored by python.linting.ignorePatterns`);
      return false;
    }
    const u = import_coc17.Uri.parse(document.uri);
    const exists = import_fs_extra4.default.existsSync(u.fsPath);
    if (!exists) {
...
var LinterProvider = class {
  constructor(context) {
    ...
    import_coc18.workspace.onDidOpenTextDocument((e) => this.onDocumentOpened(e), this.context.subscriptions);
    import_coc18.workspace.onDidCloseTextDocument((e) => this.onDocumentClosed(e), this.context.subscriptions);
    import_coc18.workspace.onDidSaveTextDocument((e) => this.onDocumentSaved(e), this.context.subscriptions);
    const disposable = import_coc18.workspace.onDidChangeConfiguration(this.lintSettingsChangedHandler.bind(this));
    this.disposables.push(disposable);
    this.disposables.push(import_coc18.commands.registerCommand("python.runLinting", this.runLinting.bind(this)));
  ...
  lintSettingsChangedHandler(e) {
    import_coc18.workspace.textDocuments.forEach((document) => {
  ...
  onDocumentClosed(document) {
    if (!document || !import_coc18.Uri.parse(document.uri).fsPath || !document.uri) {
      return;
    }
...
var RefactorProxy = class {
  ...
  async extractVariable(document, name, filePath, range) {
    const options = await import_coc19.workspace.getFormatOptions();
    const command = {
  ...
  async initialize() {
    ...
    const cwd = path9.join(this._extensionDir, "pythonFiles");
...
async function checkDocument(doc) {
  ...
  if (modified != 0) {
    import_coc20.window.showMessage("Buffer not saved, please save the buffer first!", "warning");
    return false;
  }
  return true;
}
function validateDocumentForRefactor(doc) {
  ...
  return new Promise((resolve, reject) => {
    import_coc20.workspace.nvim.command("write").then(() => {
      return resolve();
    }, reject);
  });
}
async function extractVariable(extensionDir, document, range, outputChannel) {
  ...
  if (!rope) {
    import_coc20.window.showMessage(`Module rope not installed`, "warning");
    return;
  }
  const workspaceFolder = import_coc20.workspace.getWorkspaceFolder(doc.uri);
  const workspaceRoot = workspaceFolder ? import_coc20.Uri.parse(workspaceFolder.uri).fsPath : import_coc20.workspace.cwd;
  const pythonSettings = PythonSettings.getInstance();
  return validateDocumentForRefactor(doc).then(() => {
    ...
    const rename = proxy.extractVariable(doc.textDocument, newName, import_coc20.Uri.parse(doc.uri).fsPath, range).then((response) => {
...
async function extractMethod(extensionDir, document, range, outputChannel) {
  ...
  return validateDocumentForRefactor(doc).then(() => {
    ...
    const proxy = new RefactorProxy(extensionDir, pythonSettings, workspaceRoot);
    const rename = proxy.extractMethod(doc.textDocument, newName, import_coc20.Uri.parse(doc.uri).fsPath, range).then((response) => {
      return response.results[0].diff;
    });
    return extractName(doc, newName, rename, outputChannel);
  });
  ...
  try {
    ...
    if (changeStartsAtLine >= 0) {
      ...
      for (let lineNumber = changeStartsAtLine; lineNumber < textEditor.lineCount; lineNumber += 1) {
        ...
        if (indexOfWord >= 0) {
          newWordPosition = import_coc20.Position.create(lineNumber, indexOfWord);
          break;
        }
      }
      return import_coc20.workspace.jumpTo(textEditor.uri, newWordPosition).then(() => {
        return newWordPosition;
      });
    }
    const newWordPosition_1 = null;
    if (newWordPosition_1) {
      return import_coc20.workspace.nvim.command("wa").then(() => {
        return import_coc20.commands.executeCommand("editor.action.rename", textEditor.uri, newWordPosition_1);
      });
    }
  } catch (error) {
...
${errorMessage}`);
    import_coc20.window.showMessage(`Cannot perform refactoring using selected element(s).`, "error");
...
var PyrightExtensionFeature = class {
  ...
  fillClientCapabilities(capabilities) {
    capabilities.textDocument.publishDiagnostics.tagSupport = {valueSet: [import_coc21.DiagnosticTag.Deprecated]};
  }
};
async function activate(context) {
  const state = import_coc21.extensions.getExtensionState("coc-python");
  if (state.toString() === "activated") {
    import_coc21.window.showMessage(`coc-python is installed and activated, coc-pyright will be disabled`, "warning");
    return;
  }
  if (import_semver2.lt(process.versions.node, "12.0.0")) {
    import_coc21.window.showMessage(`Pyright needs Node.js v12+ to work, your Node.js is ${process.version}.`, "error");
    return;
  }
  const module2 = context.asAbsolutePath("node_modules/pyright/langserver.index.js");
  if (!import_fs.existsSync(module2)) {
    import_coc21.window.showMessage(`Pyright file doesn't exist, please reinstall coc-pyright`, "error");
    return;
  }
  const serverOptions = {
    module: module2,
    transport: import_coc21.TransportKind.ipc
  };
  const outputChannel = import_coc21.window.createOutputChannel("Pyright");
  const config = import_coc21.workspace.getConfiguration("pyright");
  const clientOptions = {
    documentSelector,
    synchronize: {
  ...
  const client = new import_coc21.LanguageClient("pyright", "Pyright Server", serverOptions, clientOptions);
  client.registerFeature(new PyrightExtensionFeature());
  context.subscriptions.push(import_coc21.services.registLanguageClient(client));
  const formatProvider = new PythonFormattingEditProvider();
  context.subscriptions.push(import_coc21.languages.registerDocumentFormatProvider(documentSelector, formatProvider));
  context.subscriptions.push(import_coc21.languages.registerDocumentRangeFormatProvider(documentSelector, formatProvider));
  context.subscriptions.push(new LinterProvider(context));
  const codeActionProvider = new PythonCodeActionProvider();
  context.subscriptions.push(import_coc21.languages.registerCodeActionProvider(documentSelector, codeActionProvider, "Pyright"));
  ...
  textEditorCommands.forEach((commandName) => {
    context.subscriptions.push(import_coc21.commands.registerCommand(commandName, async (offset) => {
      ...
      await import_coc21.workspace.applyEdit(wsEdit);
    }));
  });
  const genericCommands = ["pyright.createtypestub"];
  genericCommands.forEach((command) => {
    context.subscriptions.push(import_coc21.commands.registerCommand(command, async (...args) => {
      const root = import_coc21.workspace.root;
      const module3 = args.pop();
      if (!module3) {
        import_coc21.window.showMessage(`Module name is missing`, "warning");
        return;
      }
      const cmd = {
        command,
  ...
  let disposable = import_coc21.commands.registerCommand("python.refactorExtractVariable", async (document, range) => {
    await extractVariable(context.extensionPath, document, range, outputChannel).catch(() => {
    });
  }, null, true);
  context.subscriptions.push(disposable);
  disposable = import_coc21.commands.registerCommand("python.refactorExtractMethod", async (document, range) => {
  ...
  const provider = {
    provideCodeActions: (document, range, actionContext) => {
      if (actionContext.only && !actionContext.only.includes(import_coc21.CodeActionKind.Refactor))
        return [];
      const commands4 = [];
      commands4.push({
  ...
  import_coc21.languages.registerCodeActionProvider(["python"], provider, "python.simpleRefactor", [import_coc21.CodeActionKind.Refactor]);
}
